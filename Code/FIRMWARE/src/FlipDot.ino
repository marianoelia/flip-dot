/*
 * Flip Dot Display
 * Description: IoT Particle Photon Flip Dot Clock
 * Author: Argon Prototypes
 * Date: July 2018
 */

/* Enable the use of retained variables upon poweroff.
 * The board has a button cell battery which provides enough power
 * to keep certain variables when unplugged
 */
...
int scrollDelay = 80; //millisecond delay between lateral shifts during a scrolling animation

const uint8_t startTransmission[3] = {0x80, 0x83, 0b00000001}; //RS485 preps the flip dot to retrieve data.
const uint8_t endTransmission[1] = {0x8F}; //RS485
...
temperatureDouble = temperatureDouble-2.1;
